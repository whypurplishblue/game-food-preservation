...
export class Pasteuriser extends Station {
  build() {
    ...
    const pipeCurve = new THREE.CatmullRomCurve3([
      new THREE.Vector3(-0.56, 1.9, 0.1), new THREE.Vector3(-0.28, 2.08, 0.1),
      new THREE.Vector3(0.28, 2.08, 0.1), new THREE.Vector3(0.56, 1.9, 0.1),
    ]);
  ...
  tick(dt, elapsed) {
    ...
    if (this._transfer !== null && this._transfer !== undefined && this.food) {
