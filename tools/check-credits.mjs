 ...
 * src/content/credits.js — either in CREDITS (a downloaded asset that
...
import { CREDITS, SELF_MADE } from '../src/content/credits.js';
...
const failed = missing.length + doubleListed.length + stale.length;
